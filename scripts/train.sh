...
python train.py start -e $epoch -m eff_v2_b0 -b 24
python train.py start -e $epoch -m eff_v2_b1 -b 16
python train.py start -e $epoch -m eff_v2_b2 -b 16
python train.py start -e $epoch -m eff_v2_b3 -b 16
