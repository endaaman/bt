...
# from timm.fx_features import register_notrace_function
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        for i_layer in range(self.num_layers):
            ...
            print((self.patch_grid[0] // (2 ** i_layer), self.patch_grid[1] // (2 ** i_layer)))
            layers += [BasicLayer(
...
class ConvStem(nn.Module):
    def __init__(self, img_size=224, patch_size=4, in_chans=3, embed_dim=768, norm_layer=None, flatten=True, output_fmt=None):
        super().__init__()
        assert patch_size == 4
